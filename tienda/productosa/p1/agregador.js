...
if (reversed == null) { reversed = false; }
	...
	this.pedido6.setTransform(835.55,561.2,0.8526,0.8526,0,0,0,74.2,67.8);

	this.pedido5 = new lib.Símbolo16();
	this.pedido5.name = "pedido5";
	this.pedido5.setTransform(775.9,561.2,0.8526,0.8526,0,0,0,74.2,67.8);

	this.pedido4 = new lib.Símbolo16();
	this.pedido4.name = "pedido4";
	this.pedido4.setTransform(717.05,561.2,0.8526,0.8526,0,0,0,74.2,67.8);

	this.pedido3 = new lib.Símbolo16();
	this.pedido3.name = "pedido3";
	this.pedido3.setTransform(656.65,561.2,0.8526,0.8526,0,0,0,74.2,67.8);
	...
	this.numerodepedido.setTransform(648.75,458.9);

	this.pedido2 = new lib.Símbolo16();
	this.pedido2.name = "pedido2";
	this.pedido2.setTransform(597.7,561.2,0.8526,0.8526,0,0,0,74.2,67.8);

	this.pedido1 = new lib.Símbolo16();
	this.pedido1.name = "pedido1";
	this.pedido1.setTransform(538.15,561.2,0.8526,0.8526,0,0,0,74.2,67.8);
	...
	this.nota.parent = this;
	this.nota.setTransform(505.45,-82.2);
	...
	this.producto.parent = this;
	this.producto.setTransform(505.45,-147.6);
	...
	this.precio.parent = this;
	this.precio.setTransform(947.85,-114.4);
...
p.nominalBounds = new cjs.Rectangle(528.3,50.4,521.7,568.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/agregador_atlas_1.png?1743249953572", id:"agregador_atlas_1"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1743249953614", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1743249953614", id:"sdk/anwidget.js"},
		{src:"components/ui/src/textinput.js?1743249953614", id:"an.TextInput"}
	],
	preloads: []
};
