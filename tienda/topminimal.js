...
lib.ssMetadata = [
		{name:"topminimal_atlas_1", frames: [[0,279,280,46],[0,0,433,91],[0,93,433,91],[0,186,433,91]]}
];
...
(lib.CachedBmp_23 = function() {
	this.initialize(ss["topminimal_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.topminimal = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(525,210.6,1,1,0,0,0,525,49.4);
	this.instance_1.alpha = 0.5195;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.logo},{t:this.instance}]}).wait(4));
...
p.nominalBounds = new cjs.Rectangle(489.8,-60,560.2,470);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/topminimal_atlas_1.png?1743861647243", id:"topminimal_atlas_1"}
	],
	preloads: []
};
